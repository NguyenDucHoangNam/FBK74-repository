...
public class ProductAdminServlet_VA extends HttpServlet {
            ...
            switch (action) {
                case "add":
                    try {
                        ...
                        String image = saveImage(request);
                ...
                {
                        ProductUpdateDAO pud = new ProductUpdateDAO();
                        pud.updateProduct(product); // Handle exception, perhaps redirect to an error page
