                ...
                <div class="main-content p-4">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <!-- Form Start -->
                            <form action="AdminEditTournament" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img src="${tournament.image}" alt="${tournament.name}" style="display: block; width: 50px; height: auto;">
                                    <!-- Assuming you might want to update the image as well, use a file input -->
