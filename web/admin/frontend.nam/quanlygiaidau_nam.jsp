                                ...
                                <div class="list-group">
                                    <c:forEach items="${tournaments}" var="tournament">
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <%--                                            <button class="btn btn-dark btn-sm me-2" type="button" onclick="window.location.href = 'kiemduyet_nam.jsp';">Kiểm duyệt</button>--%>
                                                ...
                                                <%-- <button class="btn btn-info btn-sm me-2" type="button" onclick="window.location.href = 'doibong_nam.jsp';">Đội bóng</button>--%>
                                                <button class="btn btn-warning btn-sm me-2" type="button" onclick="window.location.href = 'lichthidau_nam.jsp';">Lịch thi đấu</button>
                                                <%--                                                <button class="btn btn-success btn-sm me-2" type="button" onclick="window.location.href = 'ketqua_nam.jsp';">Kết quả</button>--%>
                                                <a href="AdminResult?IDTournament=${tournament.id}" class="btn btn-success btn-sm me-2">Kết quả</a>
                                                <a href="AdminEditTournament?IDTournament=${tournament.id}" class="btn btn-secondary btn-sm me-2">Chỉnh sửa</a>
                                                <%--                                               <button class="btn btn-secondary btn-sm me-2" type="button" onclick="window.location.href = 'chinhsuagiaidau_nam.jsp;'">Chỉnh sửa</button>--%>
                                                <%--                                                <button class="btn btn-danger btn-sm" type="button" onclick="confirmDeletion();">Xóa</button>--%>
