                        ...
                        <%
                            ...
                            if (signValue.equals(vnp_SecureHash)) {
                                if ("00".equals(request.getParameter("vnp_TransactionStatus"))) {
                                    ...
                                    int IDBill = rand.nextInt(100) + 1;
                                    while (billD.checkIDBill(IDBill) == true) {
                                        IDBill = rand.nextInt(100) + 1;
                                    }
                                    ...
                                    try {
                                        ...
                                        Bill bill = new Bill(IDBill, request.getParameter("vnp_TxnRef"), rFFD.getRegisteredFootballFielByID(rffID), null, null, null, null, formattedDate);
