...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <div class="container-md">
            <h2 class="text-primary">Đăng ký khóa học</h2>
            <jsp:include page="common/Message.jsp" />

            <form action="RegitCourse" method="post" onsubmit="return validatePhoneNumber();">
                <!-- Input fields for accountID, phoneNumber, and gender -->
    
                <input type="text" name="courseID" value="${course.getIdYouthTrainingCourse()}" required hidden="">
                <div class="mb-3">
                    <label for="NameYouthTrainingCourse" class="form-label">Tên khóa học:</label>
                    
                    <input type="text" class="form-control" value="${course.getNameYouthTrainingCourse()}" required>
                </div>
