    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <h1 class="m-4"><div class="d-none d-lg-block">
                        <c:if test="${requestScope.account==null && requestScope.name==null}">
                                <a href="login-google" class="bi-person custom-icon me-3">Login!</a></c:if>  
