 ...
 * @author ASUS
 */
@WebServlet(name = "AdminEditMemberOfTeam", urlPatterns = {"/admin/frontend.nam/AdminEditMemberOfTeam"})
public class AdminEditMemberOfTeam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminEditMemberOfTeam</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminEditMemberOfTeam at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("AdminEditTeamMemberServlet?IDTeam=" + IDTeam);
    }
