...
public class BillDAO extends DBContext {
    ...
    public void insertBillWithRegisteredFootballField(Bill bill) {
        ...
        try {
            ...
            st.setString(2, bill.getInvoice());
            st.setInt(3, bill.getRegisteredFootballField().getIDRegisteredFootballField());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Bill billT = new Bill(20, "473648", rFFD.getRegisteredFootballFielByID(74), null, null, null, null, formattedDate);
