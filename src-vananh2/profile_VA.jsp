...
<jsp:include page="header.jsp"></jsp:include>
    ...
    <style>
        #profile-picture {
            ...
            object-fit: cover; /* Đảm bảo ảnh được phủ kín mà không mất tỷ lệ */
        ...
        <div class="bg-white shadow-lg rounded-lg p-8 max-w-4xl w-full">
            <div class="flex flex-col md:flex-row justify-between items-start">
                <div class="flex flex-col items-center text-center md:text-left md:items-start">
                    ...
                    <form id="imageUploadForm" action="updateImageProfile" method="post" enctype="multipart/form-data" style="
                          padding-left: 50px">

                        <img src="img/${account.image}" alt="Profile picture" id="profile-picture">
                    <input type="file" id="image-input" name="image" style="display: none;">
                    <button type="submit" class="btn btn-group-lg" >Thay doi anh</button>
                </form>
            ...
            <div class="mt-8 md:mt-0 md:ml-10 w-full max-w-lg">
                <form class="space-y-4" action="profile1" method="POST">
...
<script>
    ...
    document.getElementById('image-input').addEventListener('change', function (event) {
        ...
        if (file) {
            ...
            // Optionally, upload the file using FormData and fetch() here
        }
    });
