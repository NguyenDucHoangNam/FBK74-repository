                    ...
                    <div class="tournament-schedule-container">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <!-- Add more rows below with the example data -->
                                <!--                                <tr>
                                                                    <td>2</td>
                                                                    <td>DD/MM/YYYY</td>
                                                                    <td>Manchester United - Ha Noi FC</td>
                                                                    <td>1-3</td>
                                                                    <td>Vòng 1 bảng B</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td>4</td>
                                                                    <td>DD/MM/YYYY</td>
                                                                    <td>Bayern Munich - Borussia Dortmund</td>
                                                                    <td>4-5</td>
                                                                    <td>Vòng 1 bảng D</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>5</td>
                                                                    <td>DD/MM/YYYY</td>
                                                                    <td>Paris Saint-Germain - Lyon</td>
                                                                    <td>3-2</td>
                                                                ...
                                                                <tr>
                                                                    <td>8</td>
                                                                    <td>DD/MM/YYYY</td>
                                                                    <td>Quang Nam FC - Aston Villa</td>
                                                                    <td>5-2</td>
                                                                    <td>Vòng 2 bảng A</td>
                                                                </tr>
                                                                <tr>
