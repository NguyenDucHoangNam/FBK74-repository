            ...
            <div class="row">
                ...
                <div class="col-md-1 d-none d-md-block">
                    <div class="advert-banner animate__animated animate__fadeIn">
                        <img src="img/quangcao2.jpg" alt="Quảng cáo bên trái" class="img-fluid">
                        <img src="img/quangcao2.jpg" alt="Quảng cáo bên trái" class="img-fluid">
                        <img src="img/quangcao2.jpg" alt="Quảng cáo bên trái" class="img-fluid">
                    </div>
                </div>
                    ...
                    <div class="tournament-list">
                        <c:forEach items="${tournaments}" var="tournament">
                            <div class="tournament-item">
                                <img src="${tournament.image}" alt="${tournament.name}" class="tournament-image" width="100" height="100">
                                <%--                                img/giaidau1.jpg--%>
