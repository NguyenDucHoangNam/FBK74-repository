                            ...
                            <c:forEach var="list" items="${requestScope.listTotalSchedule}">
                                <c:if test="${list.registeredFootballField!=null}">
                                    <tr id="${list.registeredFootballField.IDRegisteredFootballField}-rFF">
                                        ...
                                        <td>Chưa diễn ra</td>
                                        <td><a href="thanhtoanbill?idDonthanhtoan=${list.registeredFootballField.IDRegisteredFootballField}&typeDonthanhtoan=rFF" class="btn btn-light">Thanh toán</a></td>
                                    </tr>
                                </c:if>
                                <c:if test="${list.scheduleTournament!=null}">
                                    <tr id="${list.scheduleTournament.IDScheduleTournament}-sT">
                                        ...
                                        <td><a href="thanhtoanbill?idDonthanhtoan=${list.scheduleTournament.IDScheduleTournament}&typeDonthanhtoan=sT" class="btn btn-light">Thanh toán</a></td>
                                    </tr>
                                </c:if>
                                <c:if test="${list.studySchedule!=null}">
                                    <tr id="${list.studySchedule.IDStudySchedule}-sS">
                                        ...
                                        <td>Chưa diễn ra</td>
                                        <td><a href="thanhtoanbill?idDonthanhtoan=${list.studySchedule.IDStudySchedule}&typeDonthanhtoan=sS" class="btn btn-light">Thanh toán</a></td>
                                    </tr>
                                </c:if>
